...
@AutoValue
public abstract class BeneficialOwner {
  ...
  public abstract Optional<Double> getPercentage();

  public static Builder builder() {
    return new AutoValue_BeneficialOwner.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract Builder setPercentage(double percentage);

    public abstract BeneficialOwner build();
  }
}
